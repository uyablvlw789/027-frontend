...
const homeFeatureData = [
  {
    ...
    cfa: { isButton: true, content: "浏览网站" },
  },
  {
    title: "EMOJIALL",
    ...
    cfa: { isButton: false, content: "浏览网站" },
  },
  {
    title: "IPSHU",
...
function ScrollStory() {
  ...
  //   queryFn: () => {
  //     return axios.get(`${process.env.REACT_APP_API_URL}/scroll-story`, {
  //       params: {
  //         populate: "*",
  //       },
  //     });
  ...
  // const { scollstory } = data.data.data.attributes;
  // console.log(scollstory);
