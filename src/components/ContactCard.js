...
function ContactCard({ title, description, icon, buttonContent, buttonLink }) {
  return (
    <div className="p-10 rounded-md shadow-[0_0_6px_3px_rgba(0,0,0,0.05)] cursor-pointer hover:bg-gray-50 hover:-translate-y-0.5 hover:shadow-xl flex flex-col items-start">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="text-white text-xl px-6 py-2 rounded-md bg-blue-600 hover:bg-blue-800 duration-75"
      >
        {buttonContent}
      </a>
    </div>
