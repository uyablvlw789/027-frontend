    ...
    >
      <div className="flex h-full w-full justify-between">
        <div className="bottom-2 flex flex-col self-end">
          <p className=" text-white mb-1 text-2xl md:text-4xl font-bold">{title}</p>
          <div className="flex">
            <div className="text-white border border-white px-1 py-0 mr-2">{tags[0]}</div>
            <div className="text-white border border-white px-1 py-0 mr-2">{tags[1]}</div>
          </div>
        </div>
